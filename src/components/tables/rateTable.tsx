...
import { adForBodyTemplate, cpcBodyTemplate, cpmBodyTemplate, cpvBodyTemplate, demographicsBodyTemplate,  measurementBodyTemplate,  msfBodyTemplate,  networkBodyTemplate,  specialityBodyTemplate, tafBodyTemplate, } from './commonmangaetablestyle';
const RateTable = () => {
...
<Column field="baseCPC" header="BaseCPC" body={cpcBodyTemplate}></Column>
