...
const RateCard = () => {
    ...
    return (<>
        ...
        <CustomizedPrimeButton label={'Master Card Rate'} fw={600} background={tabNumb===0?'linear-gradient(to right,#A45BE4 0%, #6B42F6 70%)':'linear-gradient(to right,#dbd9d9 0%, #aaa9a9 70%)'} brad={'7px 7px 0px 0px'} color={'white'}fs={'11px'} onClickHandler={changeTab}/>
                    <CustomizedPrimeButton label={'Discount Details'} background={tabNumb===1?'linear-gradient(to right,#A45BE4 0%, #6B42F6 70%)':'linear-gradient(to right,#dbd9d9 0%, #aaa9a9 70%)'} fw={600} brad={'7px 7px 0px 0px'} color={'white'}fs={'11px'} onClickHandler={changeTab}/>
            </div>
