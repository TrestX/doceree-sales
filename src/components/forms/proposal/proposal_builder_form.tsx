...
const ProposalBuilderForm = ({manageService,setManageService,dataPro,setDataPro,network,setNetwork, setCampaignType,
    ...
    setReach, setBusinessRule,setFreq}:{manageService:boolean,setManageService:React.Dispatch<React.SetStateAction<boolean>>,dataPro:string,setDataPro:React.Dispatch<React.SetStateAction<string>>,network:string,setNetwork:React.Dispatch<React.SetStateAction<string>>, setCampaignType:React.Dispatch<React.SetStateAction<string>>,
