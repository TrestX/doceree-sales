...
import RateTable from '../tables/rate_tables/rates/rateTable';
import { CustomizedPButtonsNI, CustomizedPrimeButton } from '../buttons/pbutton';
import './ratecard.css';
import { useState } from 'react';
import RateDiscountTable from '../tables/rate_tables/discount/ratediscountTable';
const RateCard = () => {
    ...
    return (<>
        <div style={{ marginTop: '80px', marginLeft: '100px', float: 'left' }}>
            ...
            {sessionStorage.getItem('accountType') && sessionStorage.getItem('accountType') === 'admin' && <div style={{
                position: 'absolute',
                top: '155px',
                left: '1000px'
            }}>
