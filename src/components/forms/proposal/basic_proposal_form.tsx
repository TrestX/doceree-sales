    ...
    return (
        <div className="p-grid" style={{ padding: '4% 10% 4% 10%' }}>
            <div className="p-col-3" style={{ textAlign: 'left' }}>
                ...
                <span style={{ fontSize: '13px', color: '#333' }} >Agency <i className="custom-target-icon-agency pi pi-info-circle" data-pr-tooltip="Agency" data-pr-position="right" data-pr-at="right+5 top" data-pr-my="left center-2" style={{ fontSize: '11px', marginTop: '-6px' }}></i></span>
            </div>
            ...
            <div className="p-col-3" style={{ textAlign: 'left' }}>
                ...
                <span style={{ fontSize: '13px', color: '#333' }}>Client <i className="custom-target-icon-client pi pi-info-circle" data-pr-tooltip="Client" data-pr-position="right" data-pr-at="right+5 top" data-pr-my="left center-2" style={{ fontSize: '11px', marginTop: '-6px' }}></i></span>
            </div>
            <div className="p-col-7">
                <span className="p-input-icon-left" style={{ width: '100%' }}>
                    <i className="pi pi-search" color='#333' />
            ...
            <div className="p-col-3" style={{ textAlign: 'left' }}>
                ...
                <span style={{ fontSize: '13px', color: '#333' }}>Brand <i className="custom-target-icon-brand pi pi-info-circle" data-pr-tooltip="Brand" data-pr-position="right" data-pr-at="right+5 top" data-pr-my="left center-2" style={{ fontSize: '11px', marginTop: '-6px' }}></i></span>
            </div>
            <div className="p-col-7">
                <span className="p-input-icon-left" style={{ width: '100%' }}>
                    <i className="pi pi-search" color='#333' />
            ...
            <div className="p-col-3" style={{ textAlign: 'left' }}>
                ...
                <span style={{ fontSize: '13px', color: '#333' }}>Business Objective <i className="custom-target-icon-business-objective pi pi-info-circle" data-pr-tooltip="Business Objective" data-pr-position="right" data-pr-at="right+5 top" data-pr-my="left center-2" style={{ fontSize: '11px', marginTop: '-6px' }}></i></span>
            </div>
            <div className="p-col-7">
            ...
            <div className="p-col-3" style={{ textAlign: 'left' }}>
                ...
                <span style={{ fontSize: '13px', color: '#333' }}>Market <i className="custom-target-icon-market pi pi-info-circle" data-pr-tooltip="Market" data-pr-position="right" data-pr-at="right+5 top" data-pr-my="left center-2" style={{ fontSize: '11px', marginTop: '-6px' }}></i></span>
            </div>
            <div className="p-col-3" style={{ textAlign: 'left' }}>
