...
const TopBarMenu = () => {
    ...
    return (<>
        ...
        <i className="pi pi-bell" style={{'fontSize': '1.2em',color:'gray',marginRight:'20px'}} onClick={() => setSideBarV(true)}></i>
        <i className="pi pi-th-large" style={{'fontSize': '1.2em',color:'gray',marginRight:'20px'}} onClick={(e) => op.current?.toggle(e)}></i>
